...
<ul class="nav_emt">
    ...
    <?php if ($userData->users_type_id == 3) { ?>
		    ...
		    <li>
                        <label for="website"><a class="<?php if ($url_2 == 'notification_panel') echo 'active'; ?>" href="<?php echo site_url('staff/notification_panel'); ?>">Notification Panel</a></label>
                    </li>
                    <li>
                        <label for="website"><a class="<?php if ($url_2 == 'attendance_report') echo 'active'; ?>" href="<?php echo site_url('staff/attendance_report'); ?>">Attendance Report</a></label>
                    </li>	
        <?php } ?>
            </ul>
        </li>
...
<?php } ?>
    ...
    <!--                    <li><a href="<?php echo site_url('exam/results'); ?>">Results</a></li>-->
        <li>
            ...
            <ul class="lft_sub_menu">
                <li>
                    <label for="website"><a class="<?php if ($url_2 == 'exams') echo 'active'; ?>" href="<?php echo site_url('exam/exams'); ?>"> Exams </a></label>
                </li>
                <li>
        ...
        <li>
            ...
            <ul class="sub_menu">
                <li>
                    <label for="website"><a class="<?php if ($url_2 == 'notification_panel') echo 'active'; ?>" href="<?php echo site_url('exam/notification_panel'); ?>">Notification Panel</a></label>
                </li>
                <li>
                    <label for="website"><a class="<?php if ($url_2 == 'message_to_faculty') echo 'active'; ?>" href="<?php echo site_url('exam/message_to_faculty'); ?>">Message to Faculty</a></label>
                </li>
                <li>
                    <label for="website"><a class="<?php if ($url_2 == 'sendmsg') echo 'active'; ?>" href="<?php echo site_url('exam/sendmsg'); ?>">Send a Message</a></label>
                </li>
                <li>
        ...
        <li><a class="<?php if ($url_2 == 'exam_duty') echo 'active'; ?>" href="<?php echo site_url('exam/exam_duty'); ?>">Exam Duty</a></li>
        <!--<li><a class="<?php if ($url_2 == 'compose') echo 'active'; ?>" href="<?php echo site_url('email/compose'); ?>">Email</a></li>-->
    ...
    <?php } ?>
        ...
        <li>
            ...
            <ul class="lft_sub_menu">
                ...
                <li>
                    <label for="website"><a class="<?php if ($url_2 == 'student_semester_upgrade') echo 'active'; ?>" href="<?php echo site_url('admin/student_semester_upgrade'); ?>"> Student Semester Upgrade </a></label>
                </li>
                <li>
                    <label for="website"><a class="<?php if ($url_2 == 'send_msg') echo 'active'; ?>" href="<?php echo site_url('staff/send_msg'); ?>"> Send Message </a></label>
                </li>
                <li>
                    <label for="website"><a class="<?php if ($url_2 == 'notification_panel') echo 'active'; ?>" href="<?php echo site_url('admin/notification_panel'); ?>">Notification Panel</a></label>
                </li>
                <li>
                    <label for="website"><a class="<?php if ($url_2 == 'sms_modaration') echo 'active'; ?>" href="<?php echo site_url('admin/sms_modaration'); ?>"> Modarate </a></label>
                </li>
