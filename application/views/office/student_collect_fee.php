                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if (isset($student_details[0]->fee3)) {
                                        if ($student_details[0]->fee3 == "")
                                            $f3 = "-"; else
                                            $f3 = $student_details[0]->fee3;
                                    }
                                    echo $f3;
                                    ?>			</td>
...
if (isset($student_details[0]->fee4)) {
    if ($student_details[0]->fee4 == "")
        $f4 = "-"; else
        $f4 = $student_details[0]->fee4;
}
echo $f4;
?>			</td>
