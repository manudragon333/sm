...
class My_db_lib {
    ...
    private $table_rows = array(
        ...
        'semisters' => array('id', 'name', 'year', 'branch_id', 'course_id', 'college_id', 'sem_number', 'status'),
        ...
        'student_periods_attendence' => array('id', 'user_id', 'staff_user_id', 'cycle_id', 'weekday_id', 'period_id', 'subject_id', 'status', 'attendance_id', 'create_date'),
